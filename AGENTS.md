...
stale heads, and unknown remote outcomes. Run relevant checks with the pinned 
pnpm through Corepack. Keep test output compact and store failure diagnostics 
